...
SCHEMA_REGISTRY_URL = "PLAINTEXT://localhost:9092"
...
class Producer:
    ...
    def topic_already_exists(self, topic_name):
        """Checks if topic exists, this will be used to find topics from client list topics"""
    ...
    def create_topic(self):
        ...
        # the Kafka Broker.
        if self.topic_already_exists(self.topic_name):
            return
        ...
        for topic, name in new_topics.items():
            try:
                name.result()
